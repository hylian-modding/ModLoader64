...
export class SaveContext extends API.BaseObj implements API.ISaveContext {
  ...
  private checksum_addr: number = 0x1F067a;

  //Haven't looked and confirmed length of rdramRead for all

  get entrance_index(): number { return this.emulator.rdramRead32(this.entrance_index_addr); }
  set entrance_index(value: number) { this.emulator.rdramWrite32(this.entrance_index_addr, value); }

  get start_mask(): number { return this.emulator.rdramRead32(this.start_mask_addr); }
  set start_mask(value: number) { this.emulator.rdramWrite32(this.start_mask_addr, value); }

  get intro_flag(): number { return this.emulator.rdramRead32(this.intro_flag_addr); }
  set intro_flag(value: number) { this.emulator.rdramWrite32(this.intro_flag_addr, value); }

  get cutscene_number(): number { return this.emulator.rdramRead16(this.cutscene_number); }
  set cutscene_number(value: number) { this.emulator.rdramWrite16(this.cutscene_number_addr, value); }

  get world_time(): number { return this.emulator.rdramRead32(this.world_time_addr); }
  set world_time(value: number) { this.emulator.rdramWrite32(this.world_time_addr, value); }

  get owl_id(): number { return this.emulator.rdramRead32(this.owl_id_addr); }
  set owl_id(value: number) { this.emulator.rdramWrite32(this.owl_id_addr, value); }

  get night_flag(): number { return this.emulator.rdramRead32(this.night_flag_addr); }
  set night_flag(value: number) { this.emulator.rdramWrite32(this.night_flag_addr, value); }

  get time_speed(): number { return this.emulator.rdramRead32(this.time_speed_addr); }
  set time_speed(value: number) { this.emulator.rdramWrite32(this.time_speed_addr, value); }

  get current_day(): number { return this.emulator.rdramRead32(this.current_day_addr); }
  set current_day(value: number) { this.emulator.rdramWrite32(this.current_day_addr, value); }

  get days_elapsed(): number { return this.emulator.rdramRead32(this.days_elapsed_addr); }
  set days_elapsed(value: number) { this.emulator.rdramWrite32(this.days_elapsed_addr, value); }

  get link_transformation(): number { return this.emulator.rdramRead32(this.link_transformation_addr); }
  set link_transformation(value: number) { this.emulator.rdramWrite32(this.link_transformation_addr, value); }

  get have_tatl(): number { return this.emulator.rdramRead32(this.have_tatl_addr); }
  set have_tatl(value: number) { this.emulator.rdramWrite32(this.have_tatl_addr, value); }

  get player_name(): number { return this.emulator.rdramRead32(this.player_name_addr); }
  set player_name(value: number) { this.emulator.rdramWrite32(this.player_name_addr, value); }

  get heart_container(): number { return this.emulator.rdramRead32(this.heart_container_addr); }
  set heart_container(value: number) { this.emulator.rdramWrite32(this.heart_container_addr, value); }

  get start_health(): number { return this.emulator.rdramRead32(this.start_health_addr); }
  set start_health(value: number) { this.emulator.rdramWrite32(this.start_health_addr, value); }

  get magic_bar(): number { return this.emulator.rdramRead32(this.magic_bar_addr); }
  set magic_bar(value: number) { this.emulator.rdramWrite32(this.magic_bar_addr, value); }

  get magic_amount(): number { return this.emulator.rdramRead32(this.magic_amount_addr); }
  set magic_amount(value: number) { this.emulator.rdramWrite32(this.magic_amount_addr, value); }

  get rupee_amount(): number { return this.emulator.rdramRead32(this.rupee_amount_addr); }
  set rupee_amount(value: number) { this.emulator.rdramWrite32(this.rupee_amount_addr, value); }

  get double_defense(): number { return this.emulator.rdramRead32(this.double_defense_addr); }
  set double_defense(value: number) { this.emulator.rdramWrite32(this.double_defense_addr, value); }

  get_checksum(): number { return this.emulator.rdramRead16(this.checksum_addr); }

  get_item_slot(slot: API.ItemSlotType): API.ItemType { return this.emulator.rdramRead8(this. item_slot_addr + slot) as API.ItemType; }
  set_item_slot(slot: API.ItemSlotType, item: API.ItemType) { this.emulator.rdramWrite8(this. item_slot_addr + slot, item); }

  get_mask_slot(slot: API.MaskSlotType): API.MaskType { return this.emulator.rdramRead8(this. mask_slot_addr + slot) as API.MaskType; }
  set_mask_slot(slot: API.MaskSlotType, mask: API.MaskType) { this.emulator.rdramWrite8(this. mask_slot_addr + slot, mask); }
}