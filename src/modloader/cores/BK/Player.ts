...
export class Player extends API.BaseObj implements API.IPlayer {
    ...
    set animal(val: API.AnimalType) { this.emulator.rdramWrite8(this.animal_addr, val); }
    ...
    get anim_frame(): number { return this.emulator.rdramReadPtr32(this.anim_addr, 0x04); }
    set anim_frame(val: number) { this.emulator.rdramWritePtr32(this.anim_addr, 0x04, val); }

    get anim_id(): number { return this.emulator.rdramReadPtr32(this.anim_addr, 0x1c); }
    set anim_id(val: number) { this.emulator.rdramWritePtr32(this.anim_addr, 0x1c, val); }

    get flip_facing(): boolean { return this.emulator.rdramRead8(this.flip_facing_addr) === 0x01; }
    ...
    get model_index(): number { return this.emulator.rdramRead16(this.model_index_addr); }
    set model_index(val: number) { this.emulator.rdramWrite16(this.model_index_addr, val); }

    get model_ptr(): number { return this.emulator.dereferencePointer(this.model_ptr_addr); }
    set model_ptr(val: number) { this.emulator.rdramWrite32(this.model_ptr_addr, val); }

    get movement_state(): number { return this.emulator.rdramRead32(this.movement_state_addr); }
    set movement_state(val: number) { this.emulator.rdramWrite32(this.movement_state_addr, val); }

    get opacity(): number { return this.emulator.rdramRead8(this.opacity_addr); }
    ...
    get scale(): number { return this.emulator.rdramRead32(this.scale_addr); }
    set scale(val: number) { this.emulator.rdramWrite32(this.scale_addr, val); }

    get visible(): boolean { return this.emulator.rdramRead8(this.visible_addr) === 0x01; }
