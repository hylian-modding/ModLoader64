...
export class CommandBuffer_Factory {
    static VERSIONS: Map<number, Map<string, number>> = new Map([
        [0, new Map<string, number>([
            ...
            ["Actor_InitHook", /*0x800210D0*/ 0x800253C8],
