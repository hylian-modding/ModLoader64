...
import { MonkeyPatch_rdramReadBits8, MonkeyPatch_rdramWriteBits8 } from '../../monkeypatches/Mupen';
...
class N64 implements IConsole {
  ...
  constructor(rom: string, logger: ILogger) {
    ...
    let mp1: MonkeyPatch_rdramReadBits8 = new MonkeyPatch_rdramReadBits8(this.mupen);
    let mp2: MonkeyPatch_rdramWriteBits8 = new MonkeyPatch_rdramWriteBits8(this.mupen);
